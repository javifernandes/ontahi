...
export type ModelInterpretationPublicContracts = [
  import('@ontahi/core/runtime/contracts').ModelCommandRequest,
  import('@ontahi/core/runtime/contracts').ModelCommandResult,
  import('@ontahi/core/runtime/server').ModelCommandRuntime,
  typeof import('@ontahi/core/runtime/server').createModelCommandRuntime,
  ...
  typeof import('@ontahi/core/runtime/server').interpretModelRequest,
  typeof import('@ontahi/core/runtime/server').validateModelInvocation,
  typeof import('@ontahi/core/runtime/server').parseModelInterpretation,
  import('@ontahi/core/runtime/server').ModelGraphCommandExposure,
];
