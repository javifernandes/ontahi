...
it('reprojects captured Activity reads and filtering without changing envelopes or executing', async () => {
  ...
  const summary = 'TodoItem where completed = false · order by title descending · limit 25 · many';
