...
6. Keep this as an Entity Mutation Command in the Data Graph Command message family described by
   [Plan 146](../next/146-ontahi-runtime-protocol.md); do not create another endpoint or protocol.
...
- Follow-up: [Plan 146](../next/146-ontahi-runtime-protocol.md) generalizes the versioned Graph Command
