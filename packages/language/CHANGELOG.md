...
- a8e1dbc: Add opt-in headless declarative Console reads alongside the existing TS-like syntax, sharing
  ...
  execution while preserving terminal intent; invalid drafts are not converted. Console switching
  and shared authoring preferences use this same conversion boundary.
