...
- d293ff1: Accept schema-native client input types in `getOperationQueryKey`, matching the query hook overloads so portable references do not require server-only reference brands.
